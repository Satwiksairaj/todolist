...
- Build/Test command: "D:\autonomous-dev-agent\.venv\Scripts\python.exe" -m pytest tests/test_app.py -v --tb=short -x --rootdir=. --confcutdir=. -p no:flask
- Build/Test command: "D:\autonomous-dev-agent\.venv\Scripts\python.exe" -m pytest tests/test_calculator.py tests/test_math_functions.py tests/test_history.py tests/test_memory.py -v --tb=short -x --rootdir=. --confcutdir=. -p no:flask
- Build/Test command: "D:\autonomous-dev-agent\.venv\Scripts\python.exe" -m pytest tests/test_calculator.py -v --tb=short -x --rootdir=. --confcutdir=. -p no:flask
- Build/Test command: "d:\autonomous-dev-agent\.venv\Scripts\python.exe" -m pytest -q
- Build/Test command: npm install --legacy-peer-deps && npx jest --passWithNoTests
